...
@IBDesignable
open class PinCodeTextField: UIView {
    ...
    @IBInspectable public var underLineColorName: String? {
        didSet {
    ...
    @IBInspectable public var updatedUnderlineColor: UIColor = UIColor.darkGray
    ...
    private var underlineColor: UIColor = UIColor.darkGray
    ...
    private func layoutCharactersAndPlaceholders() {
        ...
        for i in 0..<underlines.count {
            ...
            if i == 0 {
                currentUnderlineX = bounds.origin.x
            }
