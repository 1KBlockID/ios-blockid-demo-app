...
target 'BlockIDTestApp' do
  ...
  pod 'BlockIDSDK', :git => 'https://github.com/1KBlockID/ios-blockidsdk.git', :tag => '1.9.00'
  pod 'YubiKit', '~> 4.2.0'
#  pod 'DocumentSelfieScanner', :git => 'https://github.com/1KBlockID/ios-supporting-sdks.git', :tag => '4.3.0'
  pod 'BlockID', :git => 'https://github.com/1KBlockID/ios-blockidsdk.git', :tag => 'blockid_sdk_1.9.00'
end
